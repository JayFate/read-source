...
const descriptor = {
  id: string, // 模块的 ID
  filename: string, // 模块的文件名
  source: string, // 模块的源代码
  query: string, // 模块的查询参数
  isEntry: boolean, // 是否是入口模块
  isAsync: boolean, // 是否是异步模块
  isCSS: boolean, // 是否是 CSS 模块
  isProd: boolean, // 是否是生产环境
  isSSR: boolean, // 是否是服务器端渲染
  assets: ?Array<string>, // 模块的静态资源
  cssVars: ?Object, // 模块的 CSS 变量
  cssModules: ?Object, // 模块的 CSS 模块
  dependencies: Array<string>, // 模块的依赖关系
  asyncDeps: Array<string>, // 模块的异步依赖关系
  imports: Array<ImportDescriptor>, // 模块的导入项
  exports: ExportDescritor, // 模块的导出项
  minify: ?string, // 是否压缩模块
}
```
...
const styleRequest = `/Users/11104760/Documents/study/vite-study/vite-demo01/src/App.vue?vue&type=style&index=0&scoped=58aba71c&lang.css`
const	styleRequest = `/Users/11104760/Documents/study/vite-study/vite-demo01/src/components/HelloWorld.vue?vue&type=style&index=0&scoped=1d5be6d4&lang.css`
